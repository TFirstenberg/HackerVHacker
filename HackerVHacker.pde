...
<<<<<<< HEAD
  //Moves the Block depending on what keys are pressed that move the Player
  ...
  //Determines if the Player is colliding with 
  public void isCollision(Player player){
=======
  //method that draws player
  void drawPlayer(){
    fill(c);
